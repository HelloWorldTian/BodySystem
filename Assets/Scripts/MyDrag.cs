    ...
    IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    Vector3 imgNormalScale = new Vector3(1.5f, 1.5f, 1);   //正常大小
    ...
    void Start()
    {
        ...
        beginPos = imgRect.localPosition;
    }
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        float y = beginPos.y;
        float x = imgRect.transform.localPosition.x;
        if (x<beginPos.x-200)
        {
            x = beginPos.x - 200;
        }
        ...
        imgRect.transform.localPosition = new Vector3(x,y,0);
    }
    ...
    {
        offset = Vector2.zero;
        imgRect.transform.localPosition = beginPos;
